...
const performSaveForElementWithFormData = (id, formData, securityId) => {
  ...
  return saveEndpoint(formData).then(input => {
    const preview = window.jQuery('.cms-preview');
    preview.entwine('ss.preview')._loadUrl(preview.find('iframe').attr('src'));
    return input;
  }).then(newPageData => {
...
const PublishAction = MenuComponent => props => {
  ...
  const handleClick = event => {
    ...
    const url = (0, _loadElementSchemaValue.loadElementSchemaValue)('publishUrl', id);
    (0, _ElementEditor.apiPut)(url, {
      SecurityID: securityId
    }).then(response => {
      reportPublicationStatus(type.title, title, response.ok);
      console.log('Setting keyB from PublishAction');
      setElementEditorContextState({
        ...elementEditorContextState,
        keyB: 789
      });
      elementEditorDispatch({
        type: _ElementEditor.ACTION_TYPE_INCREMENT_AGE
      });
      elementEditorDispatch({
        type: _ElementEditor.ACTION_TYPE_CHANGED_NAME,
        nextName: 'bob'
      });
    });
  };
...
var _default = (0, _Injector.inject)(['PopoverOptionSet'], PopoverOptionSetComponent => ({
  PopoverOptionSetComponent
...
class AddNewButton extends _react.Component {
  ...
  render() {
    ...
    return _react.default.createElement("div", null, _react.default.createElement(_reactstrap.Button, buttonAttributes, _i18n.default._t('ElementAddNewButton.ADD_BLOCK', 'Add block')), _react.default.createElement(_AddElementPopover.default, {
...
class Content extends _react.PureComponent {
  render() {
    ...
    }, !previewExpanded && _react.default.createElement(_Summary.default, {
      content: content,
      fileUrl: fileUrl,
      fileTitle: fileTitle,
      broken: broken
    }), previewExpanded && _react.default.createElement(_InlineEditForm.default, {
      extraClass: {
...
var _default = DragPositionIndicator;
exports["default"] = _default;
...
class Element extends _react.Component {
  ...
  render() {
    ...
    const content = connectDropTarget(_react.default.createElement("div", {
      ...
      onDragEnd: onDragEnd
    }), !childRenderingError && _react.default.createElement(_Content.default, {
      id: element.id,
...
var _default = (0, _redux.compose)((0, _Injector.inject)(['ActionMenu'], ActionMenuComponent => ({
  ActionMenuComponent
...
var _default = (0, _reactDnd.DragLayer)(monitor => ({
...
exports.ACTION_TYPE_INCREMENT_AGE = exports.ACTION_TYPE_CHANGED_NAME = void 0;
exports.Component = ElementEditor;
exports.ElementEditorContext = void 0;
...
const ElementEditorContext = (0, _react.createContext)(null);
exports.ElementEditorContext = ElementEditorContext;
const ACTION_TYPE_INCREMENT_AGE = 'INCREMENT_AGE';
exports.ACTION_TYPE_INCREMENT_AGE = ACTION_TYPE_INCREMENT_AGE;
const ACTION_TYPE_CHANGED_NAME = 'CHANGED_NAME';
exports.ACTION_TYPE_CHANGED_NAME = ACTION_TYPE_CHANGED_NAME;
...
function ElementEditor(_ref) {
  ...
  const [contextState, setContextState] = (0, _react.useState)(null);
  const [dragTargetElementId, setDragTargetElementId] = (0, _react.useState)(null);
  const [dragSpot, setDragSpot] = (0, _react.useState)(null);
  const [state, dispatch] = (0, _react.useReducer)(reducer, {
    age: 42
  });
  function reloadDataFromServer() {
    const url = (0, _loadElementSchemaValue.loadElementSchemaValue)('areasUrl', areaId);
    apiGet(url).then(async response => await response.json()).then(responseJson => setContextState({
      ...contextState,
      ...responseJson
    }));
  }
  ...
  (0, _react.useEffect)(() => reloadDataFromServer(), []);
  ...
  }), _react.default.createElement(_ElementList.default, {
...
class ElementList extends _react.Component {
  ...
  renderBlocks() {
    ...
    }), isDraggingOver || _react.default.createElement(_HoverBar.default, {
    ...
    if (!isDraggingOver) {
      output = [_react.default.createElement(_HoverBar.default, {
        key: 0,
        areaId: areaId,
        elementId: 0,
        elementTypes: allowedElementTypes
    ...
    if (isDraggingOver && dragIndicatorIndex !== null) {
      output.splice(dragIndicatorIndex, 0, _react.default.createElement(_DragPositionIndicator.default, {
        key: "DropIndicator"
      }));
    }
    return output;
...
var _default = (0, _redux.compose)((0, _Injector.inject)(['Loading'], LoadingComponent => ({
  LoadingComponent
...
class InlineEditForm extends _react.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement("div", {
      ...
      onClick: onClick,
      role: "presentation"
    }, _react.default.createElement(_FormBuilderLoader.default, formProps));
  }
}
...
class Toolbar extends _react.PureComponent {
  render() {
    ...
    }, _react.default.createElement(_AddNewButton.default, {
      elementTypes: elementTypes,
      areaId: areaId
    }));
  }
...
var _default = ElementalAreaHistoryFactory;
exports["default"] = _default;
...
var _default = (0, _FieldHolder.default)(TextCheckboxGroupField);
exports["default"] = _default;
...
exports.elementDragSource = elementDragSource;
...
var _default = (0, _hoc.graphql)(mutation, config);
exports["default"] = _default;
...
exports.config = config;
var _default = (0, _hoc.graphql)(query, config);
exports["default"] = _default;
...
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const elementType = _propTypes.default.shape({
...
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const elementTypeType = _propTypes.default.shape({
  name: _propTypes.default.string,
  title: _propTypes.default.string,
